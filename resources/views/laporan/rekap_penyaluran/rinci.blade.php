...
@section('header')
<title>YBM - Rekap Penyaluran Rinci</title>
@endsection
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Rekap Penyaluran Rinci</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Rekap Penyaluran Rinci {{ $tahun }}</h4>
                        <div class="basic-form">
                            <form action="{{ route('laporan.rekap-penyaluran-rinci') }}" method="post">
                                @csrf
